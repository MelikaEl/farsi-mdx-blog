...
// import Editor from "@/components/tiptap-editor";// Import the isolated MDXEditor component because the form doesn't affect the state of the MDXEditor component

// //import Editor from "@/components/tiptap-toolbar";
...
// // const DynamicEditor = dynamic(
// //   () => import('@/components/tiptap-toolbar').then((mod) => mod.Editor),
// //   { ssr: false }
// // );

// /*const Editor = dynamic(
//   () => import("@/components/tiptap-toolbar"),
//   { ssr: false }
// ); //resolve the (immediatelyRender) error*/
...
// // Separate MDXEditor component
// const MDXEditorWrapper = React.memo(({ onChange, initialContent }) => {
...
//                   plugins={[
//                     toolbarPlugin({
//                       toolbarContents: () => <EditorToolbar />, // Return the memoized component
//                     }),
//                     linkPlugin(),
//                     linkDialogPlugin(),
//                     imagePlugin()
