    ...
    posts = posts.filter((post) => {
      return (
        ...
        (Array.isArray(post.tags) &&
          post.tags.some((tag) =>
            tag && typeof tag === 'string' ? tag.toLowerCase().includes(searchTerm.toLowerCase()) : false
          )) ||
        (Array.isArray(post.categories) &&
          post.categories.some((cat) =>
            cat && typeof cat === 'string' ? cat.toLowerCase().includes(searchTerm.toLowerCase()) : false
          ))
      );
    });
  }
